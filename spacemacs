...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(prettier-js mw-thesaurus nov)
...
you should place your code here."
  ...
  ;; Set MW key
  (setq mw-thesaurus--api-key "46ba3a93-8221-4ae9-9e5a-f819efee082c")

  ;; Add nov-mode for epub files
  ...
  ;; ast-explorer
  (spacemacs|define-custom-layout "@ast-explorer"
    :binding "a"
    :body
    (find-file "~/Documents/www/js/astexplorer/website/index.ejs")
